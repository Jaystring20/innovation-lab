...
serve(async (req: Request) => {
  ...
  try {
    ...
    for (const team of input.teams) {
      ...
      if (teamError) {
        console.error(Team creation error for :, teamError);
        continue;
      }
      ...
      if (teamAuthError) {
        console.error(Team auth creation error for :, teamAuthError);
        continue;
      }
      ...
      if (teamProfileError) {
        console.error(Team profile creation error for :, teamProfileError);
        continue;
      }
