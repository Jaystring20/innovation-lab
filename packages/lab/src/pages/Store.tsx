...
const Store: React.FC = () => {
  console.log('✨ Store component loaded with onBlur caching - ' + new Date().toISOString());
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Field label="Number of teams (1 kit per team)">
                    <input
                      ...
                      min={1}
                      required
                      defaultValue={form.teamCount}
                      onBlur={(e) => {
                        const newForm = { ...form, teamCount: Number(e.target.value) };
                        setForm(newForm);
                        localStorage.setItem('store_form_cache', JSON.stringify(newForm));
                      }}
                    />
